...
>
> 5. Participates electronically in a Board meeting \(Section 5.6\)
> 6. Returns\(Section 5.7\) a ballot with respect to one or more Voting Items, which ballot is received by the Secretary on or before the date and time for the Board meeting, is counted toward satisfying the quorum requirement at the Board meeting for the Voting Item\(s\) involved or at which the Director electronically participates.
>
